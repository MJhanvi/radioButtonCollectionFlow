...
//      tagButton.layer.borderColor = self.tintColor.CGColor;
      ...
      tagButton.titleLabel.lineBreakMode = NSLineBreakByTruncatingTail;
        [tagButton setImage:[UIImage imageNamed:@"radio-on.png"] forState:UIControlStateNormal];
        [tagButton setImage:[UIImage imageNamed:@"sync_on.png"] forState:UIControlStateSelected];
      ...
      [tagButton setTitleColor:[UIColor blackColor] forState:UIControlStateSelected];
